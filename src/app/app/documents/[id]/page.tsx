...
const USERS_MAP: Record<string, string> = {
  u1: 'Асанов Бакыт Эркинович',
  u2: 'Жумагулова Айгерим Талантовна',
  u3: 'Клименко Алла Валерьевна',
  u4: 'Ташматов Данияр Эсенович',
  u5: 'Касымова Алтынай Турсуновна',
  u6: 'Бекболотов Азамат Жолдошевич',
  u7: 'Кадыров Тимур Маратович',
  u8: 'Осмонова Назгуль Алмазовна',
};

const COMPANIES_MAP: Record<string, string> = {
  c1: 'ОсОО Mad Devs',
  c2: 'ОсОО Unique Technologies',
  c3: 'ОсОО Namba One',
  c4: 'ОсОО OpenCBS',
  c5: 'ОсОО Codify',
};
