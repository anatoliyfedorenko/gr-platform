...
const DEFAULT_PARSERS: Parser[] = [
  {
    id: 'parser-1',
    name: 'Жогорку Кенеш — Законопроекты',
    sourceUrl: 'https://kenesh.kg/ru/rss/draft-laws',
    status: 'running',
  ...
  {
    id: 'parser-2',
    name: 'Минцифры КР — Новости',
    sourceUrl: 'https://digital.gov.kg/ru/news/',
    status: 'running',
  ...
  },
  {
    id: 'parser-3',
    name: 'ЦБД Минюста КР',
    sourceUrl: 'https://cbd.minjust.gov.kg/act/api/v1/',
    status: 'stopped',
  ...
  },
  {
    ...
    sourceUrl: 'https://t.me/gr_monitoring_kg',
    status: 'error',
  ...
  {
    id: 'parser-5',
    name: 'СРРС КР — Документы',
    sourceUrl: 'https://nas.gov.kg/ru/documents',
    status: 'running',
